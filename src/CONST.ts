...
const CONST = {
    ...
    TAB_TO_CENTRAL_PANE_MAPPING: {
        ...
        [SCREENS.SETTINGS_IDEAL]: [SCREENS.SETTINGS.WORKSPACES, SCREENS.WORKSPACES_IDEAL],
        [SCREENS.WORKSPACE.INITIAL]: [SCREENS.WORKSPACE.SETTINGS],
        [SCREENS.WORKSPACE_SETTINGS_IDEAL]: [SCREENS.OVERVIEW_IDEAL],
    },
} as const;
